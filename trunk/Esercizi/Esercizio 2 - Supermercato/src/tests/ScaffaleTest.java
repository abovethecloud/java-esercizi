...
public class ScaffaleTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("COD1 "+prod1.getGiacenza()+" == "+scaff1.getProdotto(scaff1.numProdottoDaCodice("COD1")).getCod()+" "+scaff1.getProdotto(scaff1.numProdottoDaCodice("COD1")).getGiacenza());
		...
		System.out.println("0 == "+scaff2.getProdotto(3).getGiacenza() + "\t cambiamento effettivo a fronte di ritiro di 50: "+cambiamento);
